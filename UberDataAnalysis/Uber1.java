...
Date date = null;String[] datefind;
private int trips,mm,dd,yy;
...
datefind=splits[1].split("/");
mm=new Integer(datefind[0]);
dd=new Integer(datefind[1]);
yy=new Integer(datefind[2]);
...
trips = new Integer(splits[2]);
String keys = basement.toString()+ " "+days[cal.get(Calendar.DAY_OF_WEEK)];
